...
- This is the first 24 February 2017 build, not a v2 public route.
- The HTTP/WebSocket route surface matches the 23 February 2017 client family.
- Server config is still GET api/config/v2 and the client deserializes
  MessageOfTheDay, MatchmakingParams, DailyObjectives, and ConfigTable.
