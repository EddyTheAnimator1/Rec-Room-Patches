"""28 September 2016 Rec Room HTTP API adapter.

Confirmed from decompiled client build 4329015347430869236:
...
21 September adapter, so this module reuses that implementation while exposing
the real requested public route `/28september2016/...`.
"""
...
API_VERSION = "28september2016"


def _load_base_adapter():
    module_path = Path(__file__).with_name("21september2016.py")
    spec = importlib.util.spec_from_file_location("recroom_api_21september2016_shared_for_28september2016", module_path)
    if spec is None or spec.loader is None:
        raise RuntimeError("Could not load 21september2016 adapter.")
