"""26 October 2016 Rec Room HTTP API adapter.

Confirmed from decompiled client build 1604792277333790762:
...
No non-Photon WebSocket API was found. The player, image, verify, config, and
tournament surface matches the 18 October adapter, with this build using the
newer RecNet.Core/Profile/Config/Images client-side wrapper classes.
"""
...
def _load_base_adapter():
    ...
    spec = importlib.util.spec_from_file_location("recroom_api_18october2016_shared_for_26october2016", module_path)
