"""29 November 2016 Rec Room HTTP/WebSocket API adapter.

Confirmed from decompiled client build 1964111244192991547:
- RecNet HTTP/WebSocket files are byte-identical to 24 November 2016.
...
API_VERSION = "29november2016"
DEFAULT_PROFILE_IMAGE_LAST_MODIFIED = "Tue, 29 Nov 2016 21:32:10 GMT"


def _load_base_adapter():
    module_path = Path(__file__).with_name("23november2016.py")
    spec = importlib.util.spec_from_file_location("recroom_api_23november2016_shared_for_29november2016", module_path)
