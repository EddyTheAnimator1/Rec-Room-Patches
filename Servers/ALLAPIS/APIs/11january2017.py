"""11 January 2017 Rec Room HTTP/WebSocket API adapter.

Confirmed from decompiled client build 4426211608086196524:
- The HTTP/WebSocket route surface matches the 7 January 2017 client family.
...
API_VERSION = "11january2017"
DEFAULT_PROFILE_IMAGE_LAST_MODIFIED = "Wed, 11 Jan 2017 00:18:10 GMT"


def _load_shared_adapter():
    module_path = Path(__file__).with_name("9december2016.py")
    spec = importlib.util.spec_from_file_location("recroom_api_9december2016_shared_for_11january2017", module_path)
