"""7 October 2016 Rec Room HTTP API adapter.

Confirmed from decompiled client build 2501384732285060244:
...
6 October adapter, so this module reuses that implementation while exposing
the real requested public route `/7october2016/...`.
"""
...
API_VERSION = "7october2016"


def _load_base_adapter():
    module_path = Path(__file__).with_name("6october2016.py")
    spec = importlib.util.spec_from_file_location("recroom_api_6october2016_shared_for_7october2016", module_path)
    if spec is None or spec.loader is None:
        raise RuntimeError("Could not load 6october2016 adapter.")
    ...
    module._BASE._BASE._PLATFORM_BASE.API_VERSION = API_VERSION
    return module
