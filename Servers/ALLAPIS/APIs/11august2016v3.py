"""11 August 2016 v3 Rec Room HTTP API adapter.

Confirmed from decompiled client build 20170328095030222:
...
adapter. Public routing stays /11august2016v3; player state is shared with
...
API_VERSION = "11august2016v3"


def _load_base_adapter():
    module_path = Path(__file__).with_name("17august2016.py")
    spec = importlib.util.spec_from_file_location("recroom_api_2016_steam_shared_for_11august2016v3", module_path)
