"""17 August 2016 v3 Rec Room HTTP API adapter.

Confirmed from decompiled client build 7115392148801672603:
...
def _load_base_adapter():
    ...
    spec = importlib.util.spec_from_file_location("recroom_api_17august2016_shared_for_v3", module_path)
